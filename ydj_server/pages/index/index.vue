<template>
	<view class="tyu">
		<view class="content">
			<view class="top">
				<bw-swiper :swiperType="swiperType" :nextMargin="nextMargin" :swiperHeight="swiperHeight" :swiperList="swiperList" style="width:100%" :autoplay="autoplay" :indicatorDots="indicatorDots">
				</bw-swiper>
				</view>
		</view>
	</view>
